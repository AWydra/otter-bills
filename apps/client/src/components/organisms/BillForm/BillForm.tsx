...
import type { ShopOptionIterface } from "interfaces";
...
const schema: yup.ObjectSchema<FormValueInterface> = yup.object().shape({
          ...
          render={({ field }) => (
            <ShopSelect
              ...
              inputProps={{
                ...
                helperText: errors.shop?.name?.message
                  ? errors.shop.name.message
                  : "",
              }}
              onChange={setValue}
            />
